...
class Scramble extends Command {
      ...
      args: [
        {
          key: 'args',
          type: 'string',
          prompt: 'Correct syntax: s!redi [# of scrambles]. For more help, see https://docs.scramblr.app/docs/scramblers/args',
          default: ''
        }
      ]
    })
  ...
  run (message, { args }) {
    ...
    const scrambles = cube('redi', count)
    let scrambleStr = ''
