...
module.exports.run = async (bot, message, args, cube) => {
	...
	let embed = new Discord.RichEmbed()
		...
		.addField("GitHub Repository", "[Check it out!](https://github.com/Bacon1153/scrambler)", true)
		...
		.addField("Description", "Scrambler is a Discord bot that generates scrambles for common twisty puzzles. Concept originated from ecuber#0566, the groundwork for the current version was written mostly by Bacon#1153, and has been revised and updated by ecuber.")
		.setTimestamp()
